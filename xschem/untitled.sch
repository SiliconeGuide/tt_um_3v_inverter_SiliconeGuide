...
C {devices/simulator_commands_shown.sym} -250 140 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
* ngspice commands
...
"
spice_ignore=false}
C {devices/launcher.sym} -40 -340 0 0 {name=h17 
descr="Load waves" 
tclcommand="
...
C {devices/launcher.sym} -40 -260 0 0 {name=h5
descr="load waves" 
